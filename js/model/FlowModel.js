...
export class FlowModel {
    ...
    // --- Node Operations ---
    addNode(type, name, value = 0, x = 0, y = 0, owner = '나', targetWeight = 0) {
        const node = {
            id: this.nextId++,
            ...
            y,
            owner,
            targetWeight, // Target allocation percentage (0-100)
            subItems: [], // Hierarchical sub-items (e.g., SSO 70%, VOO 30%)
    ...
    deserialize(jsonStr) {
        try {
            ...
            this.strategy = data.strategy || { summary: '', updatedAt: null };
            ...
            this.nodes.forEach(n => {
                ...
                if (n.targetWeight === undefined) n.targetWeight = 0;
                if (n.subItems === undefined) n.subItems = [];
